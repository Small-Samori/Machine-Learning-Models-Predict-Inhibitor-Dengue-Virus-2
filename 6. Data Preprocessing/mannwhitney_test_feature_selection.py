...
X_train_sm = pd.read_csv('Dataset/X_train_sm.csv')
y_train_sm = pd.read_csv('Dataset/y_train_sm.csv')
...
X_train_sm_reduced.to_csv('Dataset/X_train_sm_reduced.csv', index=None)
X_test_reduced.to_csv('Dataset/X_test_reduced.csv', index=None)
